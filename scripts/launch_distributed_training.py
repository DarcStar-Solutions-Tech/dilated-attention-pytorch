...
def build_command(
    ...
    **kwargs
    ...
    script_args = [
        ...
        "--num_epochs", str(kwargs.get("num_epochs", 10)),
        "--batch_size", str(training_config["micro_batch_size"]),
        ...
        "--zero_stage", str(training_config["zero_stage"])
    ]
...
def main():
    ...
    parser.add_argument("--num_gpus", "--num_gpus_per_node", type=int, default=8,
                       dest="num_gpus_per_node", help="Number of GPUs per node")
    parser.add_argument("--hardware_type", type=str, default="a100",
    ...
    parser.add_argument("--launcher", type=str, default="torchrun",
    ...
    parser.add_argument("--hostfile", type=str, default=None,
                       help="Hostfile for multi-node training")
    
    # Advanced options
    parser.add_argument("--dry_run", action="store_true",
                       help="Print command without executing")
    parser.add_argument("--custom_script", type=str, default=None,
                       help="Path to custom training script")
    ...
    if args.hostfile:
        ...
        with open(hostfile_path, 'w') as f:
            f.write(f"# Edit this hostfile with your actual node addresses\n")
