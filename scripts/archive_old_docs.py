...
This script moves old/superseded files to the archive directory.
"""
...
def main():
    ...
    for file_type, files in sorted(by_type.items()):
        ...
        for filepath, reason in sorted(files)[:5]:  # Show first 5
            try:
    ...
    # Confirm
    print("\n" + "=" * 80)
    response = input("Do you want to proceed with archiving these files? [y/N] ")
