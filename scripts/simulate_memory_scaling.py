...
def main():
    ...
    parser.add_argument("--sequence-lengths", nargs="+", type=int, required=True,
                        help="Sequence lengths to test")
    parser.add_argument("--num-heads", type=int, default=32, help="Number of attention heads")
    parser.add_argument("--head-dim", type=int, default=128, help="Head dimension")
    parser.add_argument("--batch-size", type=int, default=1, help="Batch size")
    parser.add_argument("--output", type=str, default="memory_scaling_report.json",
    ...
    for seq_len in args.sequence_lengths:
        ...
        print(f"  Speedup: {speedup['actual_speedup']:.2f}x "
