...
class TrueRingDilatedAttention(nn.Module):
    ...
    def __init__(
        ...
        self.dtype = (
            dtype or torch.float16 if self.device.type == "cuda" else torch.float32
        )
    ...
    def _chunk_kv(
        self, k: Tensor, v: Tensor, chunk_size: int
    ...
    def get_memory_usage(
        self, seq_len: int, batch_size: int, num_heads: int, head_dim: int
    ) -> dict:
        """
