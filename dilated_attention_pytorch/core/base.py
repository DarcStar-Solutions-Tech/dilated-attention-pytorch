...
class BaseDilatedAttention(nn.Module, ValidationMixin, ABC):
    ...
    def _validate_forward_inputs(self,
                               q: Tensor,
                               k: Tensor, 
                               v: Tensor,
                               attention_mask: Optional[Tensor] = None) -> None:
        """
    ...
    def _cache_get(self, cache_dict: OrderedDict, key: Any, 
...
class BaseMultiheadDilatedAttention(nn.Module, ValidationMixin, ABC):
    ...
    def __init__(self, 
        ...
        if multihead_config.layer_norm:
            self.q_ln = nn.LayerNorm(
                self.embed_dim, 
                eps=multihead_config.layer_norm_eps,
                **factory_kwargs
            )
    ...
    def forward(self,
                ...
                is_causal: bool = False) -> Union[Tensor, Tuple[Tensor, Optional[Tensor]]]:
        """
