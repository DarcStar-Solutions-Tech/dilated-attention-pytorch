...
def detailed_analysis():
    ...
    def estimate_max_tokens_optimized(config, optimization):
        ...
        total_params = (embedding_params + transformer_params) * optimization["dtype_bytes"] / (1024**3)
        ...
        activation_per_token = num_layers * embed_dim * optimization["dtype_bytes"] * optimization["activation_multiplier"] / (1024**3)
        ...
        max_tokens_improved = int(available_memory / (activation_per_token + attention_per_token_improved))
    ...
    for result in best_results:
        print(f"{result['model']:<20} {result['original']:>10,} {result['improved']:>10,} {result['memory_saved']:>8.1f} GB")
