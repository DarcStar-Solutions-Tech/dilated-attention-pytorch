...
def test_edge_cases():
    ...
    # Edge case 1: Valid sequence lengths (must be divisible by largest segment)
    print("\n1. Valid sequence lengths:")
    segments = [256, 512, 1024]
    dilations = [1, 2, 4]

    for seq_len in [1024, 2048, 4096]:  # Divisible by largest segment (1024)
