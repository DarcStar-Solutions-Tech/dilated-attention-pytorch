...
from dilated_attention_pytorch import (
    RingDilatedAttentionHilbertGPUOptimized as RingDilatedAttentionV2,
...
class TestRingDilatedAttentionIntegration:
    ...
    def test_basic_dilated_integration(self, device, dtype, basic_config, test_tensors):
        ...
        # RingDilatedAttentionHilbertGPUOptimized requires embed_dim and num_heads
    ...
    def test_head_group_distribution(self, device, dtype, basic_config):
        ...
        # Get dimensions from test_tensors
        num_heads = query.shape[2] if "query" in locals() else q.shape[2]
        head_dim = query.shape[3] if "query" in locals() else q.shape[3]
        embed_dim = num_heads * head_dim
        ring_dilated = RingDilatedAttentionV2(
            embed_dim=embed_dim,
            num_heads=num_heads,
...
if __name__ == "__main__":
    ...
    # Hard-coded dimensions for this demo
